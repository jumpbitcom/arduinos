...
void loop()
{
  int aktuelleTemperatur;
  int aktuelleLuftfeuchtigkeit;
  ...
  {
    ArduinoCloud.print("btna pressed success\n");
    M5.Lcd.clear();
...
*/
void onTemperaturChange(int temperatur)
{
...
/*
  ...
  executed every time a new value is received from IoT Cloud.
*/
void onLuftfeutigkeitChange(int luftfeuchtigkeit)
{
